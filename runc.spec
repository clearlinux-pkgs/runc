...
Version  : 1.0.0
Release  : 9
URL      : https://github.com/opencontainers/runc/archive/v1.0.0-rc1.tar.gz
Source0  : https://github.com/opencontainers/runc/archive/v1.0.0-rc1.tar.gz
